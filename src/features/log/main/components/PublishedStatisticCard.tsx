  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-3 px-1">
        ...
        <p className="text-sm font-black text-indigo-600 dark:text-indigo-400">{data.month_current}</p>
      </div>
            ...
            >
              <div className="flex flex-col">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <div className={cn("flex items-center text-[9px] font-black", diff.color)}>
                    {diff.icon}
                    <span>{diff.text}</span>
                  </div>
                </div>
              ...
              <div className="text-right">
                <p className="text-[8px] uppercase font-medium text-slate-400 leading-none opacity-0 group-hover:opacity-100 transition-opacity">Минулий</p>
                <p className="text-[11px] font-bold text-slate-500/80 leading-tight">{item.prev}</p>
              </div>
            </div>
          );
        })}
