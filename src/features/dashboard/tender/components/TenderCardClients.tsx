        ...
        <div className="col-span-4 lg:col-span-1 border-b lg:border-b-0 border-r border-zinc-200/80 dark:border-zinc-800 p-1.5 lg:p-2 flex flex-col justify-center gap-1.5 lg:gap-2.5 bg-zinc-50/30 dark:bg-white/[0.03]">
          ...
          <div className="flex flex-col gap-1 lg:gap-2.5">
            {transitPoints.map((pt, i) => (
              <div key={i} className="flex flex-col text-center lg:text-left leading-tight">
                <span className="text-[8px] lg:text-[8.5px] text-zinc-500 dark:text-zinc-400 font-black mb-0.5 uppercase tracking-tighter">
                  {pt.ids_point === "CUSTOM_UP" ? "Замитнення" : pt.ids_point === "CUSTOM_DOWN" ? "Розмитнення" : "Кордон"}
                </span>
        ...
        <div className="col-span-12 lg:col-span-1 grid grid-cols-3 divide-x divide-zinc-200/80 dark:divide-zinc-800 h-full">
          ...
          <div className="flex flex-col h-full bg-zinc-50/30 dark:bg-white/[0.02] min-h-[60px] lg:min-h-[80px]">
            <div className="p-1.5 lg:p-1 flex-grow flex flex-col items-center justify-center w-full text-center">
              ...
              {!isAuction ? (
                <>
                  <div className="flex items-center gap-0.5 justify-center font-black text-[13px] lg:text-[14px] text-zinc-800 dark:text-zinc-100">
          ...
          <div className="p-1 lg:p-1.5 flex flex-col items-center justify-center bg-emerald-50/40 dark:bg-emerald-500/[0.05] w-full min-h-[60px] lg:min-h-[80px]">
            ...
            <div className="w-full flex justify-center items-center flex-col gap-1.5 mt-auto pb-0.5 px-0.5 lg:px-0">
              ...
              <button
                ...
                disabled={!canBid || !isActive}
                className={cn(
                  "w-full h-auto text-[9.5px] lg:text-[10px] font-bold text-zinc-500 hover:text-indigo-600 dark:text-zinc-500 dark:hover:text-indigo-400 transition-colors py-0.5 disabled:opacity-50 disabled:cursor-not-allowed leading-none underline-offset-2 hover:underline",
                  isAuction && "h-[24px] lg:h-[28px] bg-indigo-600 dark:bg-indigo-500 text-white dark:text-white rounded-md !text-white no-underline"
                )}
              >
                Своя ціна
              </button>
