  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          `bg-background data-[state=open]:animate-in data-[state=closed]:animate-out fixed top-[50%] left-[50%] z-99999 grid w-full ${widthClass} max-h-[90vh] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg border shadow-lg p-6 overflow-auto duration-200`,
          className
        )}
        {...props}
      >
