export const buttonVariants = {
  ...
  variants: {
    primary:
      "bg-teal-600 text-white shadow-md shadow-teal-500/20 hover:bg-[#718AF6] hover:shadow-lg hover:shadow-teal-500/30",
    secondary:
      "bg-slate-100 text-slate-900 dark:bg-slate-800 dark:text-slate-100 hover:bg-slate-200 dark:hover:bg-slate-700",
    outline:
      "border-2 border-zinc-200 dark:border-white/10 text-zinc-600 dark:text-zinc-300 hover:border-teal-500 hover:text-teal-600 dark:hover:border-teal-500",
