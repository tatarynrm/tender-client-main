...
const PlaceholderSection = ({
  ...
  <div className="relative overflow-hidden flex flex-col items-center justify-center  border border-zinc-200 dark:border-white/10 rounded-3xl lg:rounded-[2rem] bg-white/50 dark:bg-zinc-950/40 backdrop-blur-2xl shadow-sm group">
